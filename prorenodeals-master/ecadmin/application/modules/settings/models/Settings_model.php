    ...
    public function update_Setting($post) {
        ...
        $data = array(
           ...
           /* 'career_mail' => $post['career_mail'],
			...
			'no_of_contractors' => $post['no_of_contractors'],
    ...
    public function getAllSettingsData($id) {
        ...
        foreach ($rs->result() as $row) {
            ...
            $data = array( 
				...
				'PROFILE_FEATURED_MONTHLY'=>PROFILE_FEATURED_MONTHLY,
				'PROFILE_FEATURED_YEARLY'=>PROFILE_FEATURED_YEARLY,
				'HST_RATE'=>HST_RATE,
