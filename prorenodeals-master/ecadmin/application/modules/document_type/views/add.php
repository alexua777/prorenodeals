  ...
  <div class="wrapper">
    <nav aria-label="breadcrumb">
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active"><a>Add New Document Type</a></li>
      </ol>
    </nav>
...
?>
      <div class="panel panel-default">
        <div class="panel-heading">
          <h5><i class="la la-plus-square"></i> Add New Document Type</h5>
        ...
        <div class="panel-body">
          <form id="validate" action="" class="form-horizontal" role="form" name="state" method="post" enctype="multipart/form-data">
			...
			<div class="row">
				...
				<div class="col-lg-10 col-md-9">
					<div class="custom-control custom-radio custom-control-inline">
					  <input type="radio" class="custom-control-input" id="status" name="status" value="1" checked="checked">
            ...
            <button type="button" onclick="redirect_to('<?php echo base_url() . 'document_type/list_record'; ?>');" class="btn btn-secondary">Cancel</button>                        
          </form>
        </div>
        <!-- End .panel-body --> 
      </div>
