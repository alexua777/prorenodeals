    ...
    <ul class="profile-list">
      ...
      <?php } ?>
		...
		<?php } } ?>
		 ...
		 <li><i class="zmdi zmdi-label"></i><?php echo __('myprofile_emp_sidebar_total_spent','Total Spent'); ?>: <?php echo CURRENCY;?><?php echo format_money(get_project_spend_amount($user_id));?></li>
        ...
        <li><i class="zmdi zmdi-label"></i> <?php echo __('myprofile_emp_amount_earned','Amount Earned'); ?>: <?php echo CURRENCY;?> <?php echo format_money(get_earned_amount($user_id));?></li>
