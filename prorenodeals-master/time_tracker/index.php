...
if ($ACT == "appsetting") {
    ...
    $XML = '<?xml version="1.0" encoding="utf-16"?>
                        <List>
                         <appsetting>
                                <forgot>http://localhost/flance_v3/forgot_pass</forgot>
                                <about>http://localhost/information/info/about_us/</about>
                                <newaccount>http://localhost/</newaccount>
                                <help>http://localhost/information/info/how_it_works/</help>
                                <watermark>Flance</watermark>
                         </appsetting>
                        </List>';
    echo $XML;
    die();
			...
			<List>
			 <userinfo>
				...
				<eamil>' . $REC['email'] . '</eamil>
                                <report>http://localhost/demo/dashboard/myproject_working</report>
                                <profile>http://localhost/demo/dashboard</profile>
			 </userinfo>
			</List>';
        echo $XML;
    }
