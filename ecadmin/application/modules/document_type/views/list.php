  ...
  <div class="wrapper">
    <nav aria-label="breadcrumb">
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active"><a>Document Type</a></li>
      </ol>
    </nav>
      ...
      <div id="prod">
        <table class="table adminmenu_list" id="example1">
          ...
          <tr>
			...
			<?php
				$atr2 = array('class' => 'la la-edit _165x', 'title' => 'Edit Document Type');
				echo anchor(base_url() . 'document_type/edit/' . $val['document_type_id'].'/', '&nbsp;', $atr2);
				echo anchor(base_url() . 'document_type/delete_plan/' . $val['document_type_id'] , '&nbsp;', $attr);
			?></td>
          </tr>
          <?php
                                }
