                            ...
                            if (count($all_data) > 0) {
                                foreach ($all_data as $key => $val) { ?>
                                    ...
                                    <tr> 
                                        ...
                                        <td><?php echo !empty($val['dispute_id']) ? $val['dispute_id'] : '-'; ?></td>
										...
										<td><?php echo !empty($val['add_date']) ? $val['add_date'] : '--'; ?></td>
										<td>$ <?php echo !empty($val['amount']) ? $val['amount'] : '0.00'; ?></td>
										<td class="text-center">
										<?php 
										if($val['admin_involve'] == '1'){
											echo 'Yes';
										}else{
											echo 'No';
										}
										?>
										 ...
										 <td class="text-center"><?php echo $val['dispute_settled'] == '1' ? '<font color="green">Settled</font>' : '<font color="red">Not Settled</font>';?></td>
										<td align="right"><a href="<?php echo base_url('fund/view_diputes/'.$val['dispute_id']); ?>" title="View"><i class="la la-eye _165x"></i></a></td>
