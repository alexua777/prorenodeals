            ...
            <div class="col-sm-12">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body"> 
                        ...
                        <form id="validate" action="<?php echo base_url(); ?>skills_new/add" class="form-horizontal" role="form" name="adminmenu" method="post" enctype="multipart/form-data">
                            ...
                            <?php } ?>														<div class="row">								<label class="col-lg-2 col-md-3 col-form-label" for="required">Skill Image(40px X 47px) </label>								<div class="col-lg-10 col-md-9">									<div class="custom-file mt-1">									  <input type="file" class="custom-file-input" id="userfile" name="userfile">									  <label class="custom-file-label" for="userfile">Choose file</label>									</div>								</div>							</div>								
                            <div class="row">
						...
						<div class="row">
							<label class="col-lg-2 col-md-3 col-form-label">Show on Home</label>
							<div class="col-lg-10 col-md-9">
								<div class="custom-control custom-radio custom-control-inline">
								  <input type="radio" class="custom-control-input" id="home_status" name="home_status" value="Y" checked="checked">
								  <label class="custom-control-label" for="home_status">Yes</label>
								</div>
								<div class="custom-control custom-radio custom-control-inline">
								  <input type="radio" class="custom-control-input"  id="status_2" name="home_status" value="N" <?php echo set_checkbox('home_status', 'N'); ?>>
								  <label class="custom-control-label" for="status_2">No</label>
								</div>                                                  
							</div>
                        </div>  
                            ...
                            <div class="row">
                                <div class="col-lg-2 col-md-3">&nbsp;</div>
                  				<div class="col-lg-10 col-md-9">
                                        ...
                                        <button type="button" onclick="redirect_to('<?php echo base_url() . 'skills_new/'; ?>');" class="btn btn-secondary">Cancel</button>
