                ...
                <div class="col-sm-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            <form id="validate" action="<?php echo base_url(); ?>skills_new/edit_new/" class="form-horizontal" role="form" name="adminmenu" method="post" enctype="multipart/form-data">
                             ...
                             <input type="text"  value="<?php echo $swedish_skill_name; ?>" name="swedish_skill_name" class="form-control">
								...
								<div class="row">
									<label class="col-lg-2 col-md-3 col-form-label" for="required">Skill Image (40px X 47px)</label>
									<div class="col-lg-10 col-md-9">
									<?php
									if($image!='')
									{
									?>
									<input type="hidden" name="currimage" value="<?php echo $image;?>"/>
									<img src="<?php echo SITE_URL;?>assets/skill_image/<?php echo $image?>" alt="Skill image" width="40" height="47" style="background-color: rgb(228, 228, 228);"/><br />
									<?php
									}
									?>                                            
									<div class="custom-file mt-1">
								...
								<div class="row">
                                     <label for="radio" class="col-lg-2 col-md-3 col-form-label">Show on Home</label>
                                     <div class="col-lg-10 col-md-9">
                                         <div class="custom-control custom-radio custom-control-inline">
                                        ...
                                        <div class="custom-control custom-radio custom-control-inline">
                                          <input type="radio" class="custom-control-input" id="status_2" name="home_status" value="N" <?php if ($home_status == 'N') { echo 'checked'; } ?>>
